# -*- coding: utf-8 -*-
"""
Created on Tue Aug 18 16:23:16 2022
...
client = vonage.Client(key="a6fb3cb7", secret="UyT6SXP8eNsTB268")
...
def send_mail_function(date, time, number_of_elephant):
    ...
    try:
        sender_email = "danushiliyanage10@gmail.com"
        receiver_email = "nightmail7083@gmail.com"
        password = "ahzthgsizmbzhifb"
            ...
            responseData = sms.send_message(
             {
                  "from": "Vonage APIs",
                    "to": "94761583364",
                    "text": "Warning : Elephant has been detected on place 1.Please take Immidiate action to Secure the Train Ride",
             }
            )
            ...
            responseData = sms.send_message(
               {
                 "from": "Vonage APIs",
                 "to": "94761583364",
                 "text": "Warning : {}Elephants has been detected on place 1.Please take Immidiate action to Secure the Train Ride".format(number_of_elephant),
               }
             )
            if responseData["messages"][0]["status"] == "0":
              print("Message sent successfully.")
        ...
        subject_text = """
                ...
                <body>
                    ...
                    <p>This alert message was reported by automatic elephant intrusion detection system. The device ID is 124HHG. The alert message was received from Place 1 area. {} Secure the Train Ride before the incident take place.</p>
                    
                    <p>Thank you!</p>
                    
                    <p style='text-align:center;color:blue;'>Developed by L.D. Mandira </p>
